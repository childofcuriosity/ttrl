...
DATA_LOCAL_DIR="./data"
BACKBONE_PATH="./llms/${BACKBONE}"
# BACKBONE_PATH="checkpoints/TTRL-verl/AIME-TTT-Qwen2.5-Math-1.5B/1121/TTRL-Len@3k-grpo-172502/global_step_240/actor/merged_hf_model"
